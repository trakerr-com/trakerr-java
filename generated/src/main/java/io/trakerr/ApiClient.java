...
public class ApiClient {
    ...
    private String basePath = "https://www.trakerr.io/api/v1";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://www.trakerr.io/api/v1
    ...
    private void CloseResponseBodyQuietly(ResponseBody body) {
        if (body != null) {
            try {
                body.close();
            } catch (IOException e) {
